            ...
            <div className="h-[500px] cursor-pointer" onClick={() => setExpandedSummaryChart("mmNet")}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 25, right: 5, left: -15, bottom: 5 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#27272a" />
                  <XAxis dataKey="label" tick={{ fill: "#ffffff", fontSize: 12 }} angle={-90} textAnchor="start" height={100} interval={0} dy={55} dx={-5} />
              ...
              <ResponsiveContainer width="100%" height="100%">
                {expandedSummaryChart === "grossChanges" ? (
                  <BarChart data={data} margin={{ top: 45, right: 20, left: -10, bottom: 120 }}>
                    <CartesianGrid strokeDasharray="3 3" stroke="#27272a" />
                    <XAxis dataKey="label" tick={{ fill: "#ffffff", fontSize: 18 }} angle={-90} textAnchor="start" height={120} interval={0} dy={70} dx={-5} />
